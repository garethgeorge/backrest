...
func TestConfig(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			store:  &CachingValidatingStore{ConfigStore: &JsonFileStore[*v1.Config]{Path: dir + "/default-config.json"}},
		},
		{
			...
			store: &CachingValidatingStore{ConfigStore: &JsonFileStore[*v1.Config]{Path: dir + "/valid-config.json"}},
		},
		{
			...
			store:           &CachingValidatingStore{ConfigStore: &JsonFileStore[*v1.Config]{Path: dir + "/invalid-config.json"}},
			wantErr:         true,
		...
		},
		{
			...
			store:           &CachingValidatingStore{ConfigStore: &JsonFileStore[*v1.Config]{Path: dir + "/invalid-config2.json"}},
			wantErr:         true,
		...
		},
		{
			...
			store:           &CachingValidatingStore{ConfigStore: &JsonFileStore[*v1.Config]{Path: dir + "/invalid-config3.json"}},
			wantErr:         true,
