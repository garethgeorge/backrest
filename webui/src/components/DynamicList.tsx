import { Flex, Stack, IconButton, Input, createListCollection } from "@chakra-ui/react";
...
const FlagAutocomplete = ({ value, onChange, placeholder }: { value: string, onChange: (val: string) => void, placeholder?: string }) => {
...
export const DynamicList = ({ label, items, onUpdate, tooltip, placeholder, required, autocompleteType = 'none' }: DynamicListProps) => {
