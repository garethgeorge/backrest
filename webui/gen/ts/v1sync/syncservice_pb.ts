...
export type SyncStreamItem_SyncEstablishSharedSecret = Message<"v1sync.SyncStreamItem.SyncEstablishSharedSecret"> & {
  /**
   * raw ECDH P-256 public key bytes
   *
   * @generated from field: bytes ecdh_public_key = 1;
   */
