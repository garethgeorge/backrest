...
export const file_v1_config: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_empty, file_v1_crypto]);
...
export type Hook = Message<"v1.Hook"> & {
  ...
  action: {
    ...
    /**
     * @generated from field: v1.Hook.OsNotification action_os_notification = 107;
     */
    value: Hook_OsNotification;
    case: "actionOsNotification";
  } | { case: undefined; value?: undefined };
};
...
/**
 * @generated from message v1.Hook.OsNotification
 */
export type Hook_OsNotification = Message<"v1.Hook.OsNotification"> & {
  /**
  ...
  /**
   * @generated from field: v1.Hook.OsNotification.DeliveryMode delivery_mode = 3;
   */
  deliveryMode: Hook_OsNotification_DeliveryMode;
};

/**
 * Describes the message v1.Hook.OsNotification.
 * Use `create(Hook_OsNotificationSchema)` to create a new message.
 */
export const Hook_OsNotificationSchema: GenMessage<Hook_OsNotification> = /*@__PURE__*/
  messageDesc(file_v1_config, 10, 7);

/**
 * @generated from enum v1.Hook.OsNotification.DeliveryMode
 */
export enum Hook_OsNotification_DeliveryMode {
  /**
   * @generated from enum value: SILENT = 0;
   */
  SILENT = 0,

  /**
   * @generated from enum value: CHIME = 1;
   */
  CHIME = 1,
}

/**
 * Describes the enum v1.Hook.OsNotification.DeliveryMode.
 */
export const Hook_OsNotification_DeliveryModeSchema: GenEnum<Hook_OsNotification_DeliveryMode> = /*@__PURE__*/
  enumDesc(file_v1_config, 10, 7, 0);
