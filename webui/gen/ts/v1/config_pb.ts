...
export const file_v1_config: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_empty, file_v1_crypto]);
...
export type Multihost = Message<"v1.Multihost"> & {
   ...
   *
   * @generated from field: repeated v1.Multihost.PairingToken pairing_tokens = 4;
   */
  pairingTokens: Multihost_PairingToken[];
};
...
export type Multihost_Peer = Message<"v1.Multihost.Peer"> & {
   ...
   *
   * @generated from field: string initial_pairing_secret = 6;
   */
...
export const Multihost_PeerSchema: GenMessage<Multihost_Peer> = /*@__PURE__*/
  messageDesc(file_v1_config, 1, 0);

/**
 * @generated from message v1.Multihost.PairingToken
 */
export type Multihost_PairingToken = Message<"v1.Multihost.PairingToken"> & {
  /**
   ...
   *
   * @generated from field: repeated v1.Multihost.Permission permissions = 7;
   */
  permissions: Multihost_Permission[];
};

/**
 * Describes the message v1.Multihost.PairingToken.
 * Use `create(Multihost_PairingTokenSchema)` to create a new message.
 */
export const Multihost_PairingTokenSchema: GenMessage<Multihost_PairingToken> = /*@__PURE__*/
  messageDesc(file_v1_config, 1, 1);
...
export const Multihost_PermissionSchema: GenMessage<Multihost_Permission> = /*@__PURE__*/
  messageDesc(file_v1_config, 1, 2);
...
export enum Multihost_Permission_Type {
   ...
   *
   * @generated from enum value: PERMISSION_RECEIVE_SHARED_REPOS = 4;
   */
...
export type Repo = Message<"v1.Repo"> & {
   ...
   *
   * @generated from field: bool shared = 13;
   */
  shared: boolean;
   ...
   *
   * @generated from field: v1.ForgetPolicy forget_policy = 15;
   */
  forgetPolicy?: ForgetPolicy | undefined;
};
...
export const RetentionPolicy_TimeBucketedCountsSchema: GenMessage<RetentionPolicy_TimeBucketedCounts> = /*@__PURE__*/
  messageDesc(file_v1_config, 5, 0);

/**
 * @generated from message v1.ForgetPolicy
 */
export type ForgetPolicy = Message<"v1.ForgetPolicy"> & {
  /**
  ...
  /**
   * @generated from field: v1.RetentionPolicy retention = 2;
   */
  retention?: RetentionPolicy | undefined;
};

/**
 * Describes the message v1.ForgetPolicy.
 * Use `create(ForgetPolicySchema)` to create a new message.
 */
export const ForgetPolicySchema: GenMessage<ForgetPolicy> = /*@__PURE__*/
...
export type Hook = Message<"v1.Hook"> & {
  ...
  action: {
    ...
    /**
     * @generated from field: v1.Hook.Telegram action_telegram = 107;
     */
    value: Hook_Telegram;
    case: "actionTelegram";
  } | { case: undefined; value?: undefined };
...
/**
 * @generated from message v1.Hook.Telegram
 */
export type Hook_Telegram = Message<"v1.Hook.Telegram"> & {
  /**
...
/**
 * Describes the message v1.Hook.Telegram.
 * Use `create(Hook_TelegramSchema)` to create a new message.
 */
export const Hook_TelegramSchema: GenMessage<Hook_Telegram> = /*@__PURE__*/
  messageDesc(file_v1_config, 10, 7);
...
export type Auth = Message<"v1.Auth"> & {
  /**
   * DEPRECATED: use auth_driver="disabled". When true it takes precedence over auth_driver.
   *
  ...
  /**
   * users to allow access to the UI. only valid when auth_driver is "local".
   *
  ...
  /**
   * "disabled", "local" (default when empty), or "oidc".
   *
   * @generated from field: string auth_driver = 3;
   */
  authDriver: string;

  /**
   * OpenID Connect settings. only valid when auth_driver is "oidc".
   *
   * @generated from field: v1.OidcConfig oidc = 4;
   */
...
/**
 * @generated from message v1.OidcConfig
 */
export type OidcConfig = Message<"v1.OidcConfig"> & {
  /**
   * OIDC issuer URL (used for .well-known discovery). required.
   *
  ...
  /**
   * OAuth2 client secret. optional (empty for public clients).
   *
  ...
  /**
   * OAuth2 scopes to request. defaults to openid, email, profile when empty.
   *
  ...
  /**
   * OAuth2 redirect URL. optional; derived from the request host when empty.
   *
  ...
  /**
   * if set, only these email addresses may log in. optional.
   *
   * @generated from field: repeated string allowed_emails = 6;
   */
  allowedEmails: string[];

  /**
   * if set, only emails in these domains may log in. optional.
   *
...
/**
 * Describes the message v1.OidcConfig.
