...
var file_v1_service_proto_depIdxs = []int32{
	...
	8,  // 9: v1.ResticUI.PathAutocomplete:input_type -> types.StringValue
	6,  // 10: v1.ResticUI.GetConfig:output_type -> v1.Config
	6,  // 11: v1.ResticUI.SetConfig:output_type -> v1.Config
	6,  // 12: v1.ResticUI.AddRepo:output_type -> v1.Config
	9,  // 13: v1.ResticUI.GetOperationEvents:output_type -> v1.OperationEvent
	10, // 14: v1.ResticUI.GetOperations:output_type -> v1.OperationList
	11, // 15: v1.ResticUI.ListSnapshots:output_type -> v1.ResticSnapshotList
	3,  // 16: v1.ResticUI.ListSnapshotFiles:output_type -> v1.ListSnapshotFilesResponse
	5,  // 17: v1.ResticUI.Backup:output_type -> google.protobuf.Empty
	12, // 18: v1.ResticUI.PathAutocomplete:output_type -> types.StringList
