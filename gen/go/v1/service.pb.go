...
type SyncStreamItem_ConnectionState int32

const (
	SyncStreamItem_CONNECTION_STATE_UNKNOWN      SyncStreamItem_ConnectionState = 0
	SyncStreamItem_CONNECTION_STATE_CONNECTED    SyncStreamItem_ConnectionState = 1
	SyncStreamItem_CONNECTION_STATE_PENDING      SyncStreamItem_ConnectionState = 2 // Never sent over the wire, tracked by client to indicate that the request is sent but not ack'd.
	SyncStreamItem_CONNECTION_STATE_DISCONNECTED SyncStreamItem_ConnectionState = 3 // Disconnected for possibly unknown reasons. Client should reconnect eventually.
	SyncStreamItem_CONNECTION_STATE_UNAUTHORIZED SyncStreamItem_ConnectionState = 4
)

// Enum value maps for SyncStreamItem_ConnectionState.
var (
	SyncStreamItem_ConnectionState_name = map[int32]string{
		0: "CONNECTION_STATE_UNKNOWN",
		1: "CONNECTION_STATE_CONNECTED",
		2: "CONNECTION_STATE_PENDING",
		3: "CONNECTION_STATE_DISCONNECTED",
		4: "CONNECTION_STATE_UNAUTHORIZED",
	}
	SyncStreamItem_ConnectionState_value = map[string]int32{
		"CONNECTION_STATE_UNKNOWN":      0,
		"CONNECTION_STATE_CONNECTED":    1,
		"CONNECTION_STATE_PENDING":      2,
		"CONNECTION_STATE_DISCONNECTED": 3,
		"CONNECTION_STATE_UNAUTHORIZED": 4,
	}
)

func (x SyncStreamItem_ConnectionState) Enum() *SyncStreamItem_ConnectionState {
	p := new(SyncStreamItem_ConnectionState)
	*p = x
	return p
}

func (x SyncStreamItem_ConnectionState) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SyncStreamItem_ConnectionState) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_service_proto_enumTypes[1].Descriptor()
}

func (SyncStreamItem_ConnectionState) Type() protoreflect.EnumType {
	return &file_v1_service_proto_enumTypes[1]
}

func (x SyncStreamItem_ConnectionState) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use SyncStreamItem_ConnectionState.Descriptor instead.
func (SyncStreamItem_ConnectionState) EnumDescriptor() ([]byte, []int) {
...
type SyncConnectionInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	RepoId          string                         `protobuf:"bytes,2,opt,name=repo_id,json=repoId,proto3" json:"repo_id,omitempty"`
	ConnectionState SyncStreamItem_ConnectionState `protobuf:"varint,3,opt,name=connection_state,json=connectionState,proto3,enum=v1.SyncStreamItem_ConnectionState" json:"connection_state,omitempty"`
	Message         string                         `protobuf:"bytes,4,opt,name=message,proto3" json:"message,omitempty"`
	LastActivityMs  int64                          `protobuf:"varint,5,opt,name=last_activity_ms,json=lastActivityMs,proto3" json:"last_activity_ms,omitempty"` // time in milliseconds since last activity.
}

func (x *SyncConnectionInfo) Reset() {
	*x = SyncConnectionInfo{}
	mi := &file_v1_service_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *SyncConnectionInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SyncConnectionInfo) ProtoMessage() {}

func (x *SyncConnectionInfo) ProtoReflect() protoreflect.Message {
	mi := &file_v1_service_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SyncConnectionInfo.ProtoReflect.Descriptor instead.
func (*SyncConnectionInfo) Descriptor() ([]byte, []int) {
	return file_v1_service_proto_rawDescGZIP(), []int{14}
}

func (x *SyncConnectionInfo) GetInstanceId() string {
	if x != nil {
		return x.InstanceId
	}
	return ""
...
func (x *SyncConnectionInfo) GetRepoId() string {
	if x != nil {
		return x.RepoId
	}
	return ""
...
func (x *SyncConnectionInfo) GetConnectionState() SyncStreamItem_ConnectionState {
	if x != nil {
...
func (x *SyncConnectionInfo) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *SyncConnectionInfo) GetLastActivityMs() int64 {
	if x != nil {
...
type SyncStreamItem_SyncActionUpdateConnectionState struct {
	...
	RepoId  string                         `protobuf:"bytes,1,opt,name=repo_id,json=repoId,proto3" json:"repo_id,omitempty"`
	State   SyncStreamItem_ConnectionState `protobuf:"varint,2,opt,name=state,proto3,enum=v1.SyncStreamItem_ConnectionState" json:"state,omitempty"`
...
func (x *SyncStreamItem_SyncActionUpdateConnectionState) GetState() SyncStreamItem_ConnectionState {
	if x != nil {
		return x.State
	}
	return SyncStreamItem_CONNECTION_STATE_UNKNOWN
...
var file_v1_service_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x22, 0x95, 0x0b, 0x0a, 0x0e, 0x53, 0x79, 0x6e, 0x63, 0x53, 0x74, 0x72, 0x65, 0x61,
	...
	0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x70, 0x6f, 0x49, 0x64, 0x1a, 0x8e, 0x01, 0x0a, 0x1f, 0x53,
	...
	0x06, 0x72, 0x65, 0x70, 0x6f, 0x49, 0x64, 0x12, 0x38, 0x0a, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65,
	0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x22, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x79, 0x6e, 0x63,
	0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x49, 0x74, 0x65, 0x6d, 0x2e, 0x43, 0x6f, 0x6e, 0x6e, 0x65,
	...
	0x28, 0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x1a, 0xf5, 0x01, 0x0a, 0x18,
	...
	0x03, 0x52, 0x07, 0x64, 0x65, 0x6c, 0x61, 0x79, 0x4d, 0x73, 0x22, 0xb3, 0x01, 0x0a, 0x0f, 0x43,
	...
	,
	...
	,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x32, 0x4b, 0x0a, 0x13, 0x42, 0x61, 0x63, 0x6b,
	0x72, 0x65, 0x73, 0x74, 0x53, 0x79, 0x6e, 0x63, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x34, 0x0a, 0x04, 0x53, 0x79, 0x6e, 0x63, 0x12, 0x12, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x79, 0x6e,
	0x63, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x49, 0x74, 0x65, 0x6d, 0x1a, 0x12, 0x2e, 0x76, 0x31,
	0x2e, 0x53, 0x79, 0x6e, 0x63, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x49, 0x74, 0x65, 0x6d, 0x22,
...
var file_v1_service_proto_goTypes = []any{
	...
	(SyncStreamItem_ConnectionState)(0),                    // 1: v1.SyncStreamItem.ConnectionState
	(*OpSelector)(nil),                                     // 2: v1.OpSelector
	(*DoRepoTaskRequest)(nil),                              // 3: v1.DoRepoTaskRequest
	(*ClearHistoryRequest)(nil),                            // 4: v1.ClearHistoryRequest
	(*ForgetRequest)(nil),                                  // 5: v1.ForgetRequest
	(*ListSnapshotsRequest)(nil),                           // 6: v1.ListSnapshotsRequest
	(*GetOperationsRequest)(nil),                           // 7: v1.GetOperationsRequest
	(*RestoreSnapshotRequest)(nil),                         // 8: v1.RestoreSnapshotRequest
	(*ListSnapshotFilesRequest)(nil),                       // 9: v1.ListSnapshotFilesRequest
	(*ListSnapshotFilesResponse)(nil),                      // 10: v1.ListSnapshotFilesResponse
	(*LogDataRequest)(nil),                                 // 11: v1.LogDataRequest
	...
	(*SyncStreamItem)(nil),                                 // 15: v1.SyncStreamItem
	(*SyncConnectionInfo)(nil),                             // 16: v1.SyncConnectionInfo
...
var file_v1_service_proto_depIdxs = []int32{
	...
	2,  // 1: v1.ClearHistoryRequest.selector:type_name -> v1.OpSelector
	2,  // 2: v1.GetOperationsRequest.selector:type_name -> v1.OpSelector
	...
	1,  // 12: v1.SyncConnectionInfo.connection_state:type_name -> v1.SyncStreamItem.ConnectionState
	18, // 13: v1.SummaryDashboardResponse.Summary.recent_backups:type_name -> v1.SummaryDashboardResponse.BackupChart
	25, // 14: v1.SummaryDashboardResponse.BackupChart.status:type_name -> v1.OperationStatus
	1,  // 15: v1.SyncStreamItem.SyncActionUpdateConnectionState.state:type_name -> v1.SyncStreamItem.ConnectionState
	2,  // 16: v1.SyncStreamItem.SyncActionDiffOperations.have_operations_selector:type_name -> v1.OpSelector
	26, // 17: v1.SyncStreamItem.SyncActionSendOperations.event:type_name -> v1.OperationEvent
	27, // 18: v1.Backrest.GetConfig:input_type -> google.protobuf.Empty
	28, // 19: v1.Backrest.SetConfig:input_type -> v1.Config
	29, // 20: v1.Backrest.CheckRepoExists:input_type -> v1.Repo
	29, // 21: v1.Backrest.AddRepo:input_type -> v1.Repo
	27, // 22: v1.Backrest.GetOperationEvents:input_type -> google.protobuf.Empty
	7,  // 23: v1.Backrest.GetOperations:input_type -> v1.GetOperationsRequest
	6,  // 24: v1.Backrest.ListSnapshots:input_type -> v1.ListSnapshotsRequest
	9,  // 25: v1.Backrest.ListSnapshotFiles:input_type -> v1.ListSnapshotFilesRequest
	30, // 26: v1.Backrest.Backup:input_type -> types.StringValue
	3,  // 27: v1.Backrest.DoRepoTask:input_type -> v1.DoRepoTaskRequest
	5,  // 28: v1.Backrest.Forget:input_type -> v1.ForgetRequest
	8,  // 29: v1.Backrest.Restore:input_type -> v1.RestoreSnapshotRequest
	31, // 30: v1.Backrest.Cancel:input_type -> types.Int64Value
	11, // 31: v1.Backrest.GetLogs:input_type -> v1.LogDataRequest
	13, // 32: v1.Backrest.RunCommand:input_type -> v1.RunCommandRequest
	31, // 33: v1.Backrest.GetDownloadURL:input_type -> types.Int64Value
	4,  // 34: v1.Backrest.ClearHistory:input_type -> v1.ClearHistoryRequest
	30, // 35: v1.Backrest.PathAutocomplete:input_type -> types.StringValue
	27, // 36: v1.Backrest.GetSummaryDashboard:input_type -> google.protobuf.Empty
	15, // 37: v1.BackrestSyncService.Sync:input_type -> v1.SyncStreamItem
	28, // 38: v1.Backrest.GetConfig:output_type -> v1.Config
	28, // 39: v1.Backrest.SetConfig:output_type -> v1.Config
	32, // 40: v1.Backrest.CheckRepoExists:output_type -> types.BoolValue
	28, // 41: v1.Backrest.AddRepo:output_type -> v1.Config
	26, // 42: v1.Backrest.GetOperationEvents:output_type -> v1.OperationEvent
	33, // 43: v1.Backrest.GetOperations:output_type -> v1.OperationList
	34, // 44: v1.Backrest.ListSnapshots:output_type -> v1.ResticSnapshotList
	10, // 45: v1.Backrest.ListSnapshotFiles:output_type -> v1.ListSnapshotFilesResponse
	27, // 46: v1.Backrest.Backup:output_type -> google.protobuf.Empty
	27, // 47: v1.Backrest.DoRepoTask:output_type -> google.protobuf.Empty
	27, // 48: v1.Backrest.Forget:output_type -> google.protobuf.Empty
	27, // 49: v1.Backrest.Restore:output_type -> google.protobuf.Empty
	27, // 50: v1.Backrest.Cancel:output_type -> google.protobuf.Empty
	35, // 51: v1.Backrest.GetLogs:output_type -> types.BytesValue
	31, // 52: v1.Backrest.RunCommand:output_type -> types.Int64Value
	30, // 53: v1.Backrest.GetDownloadURL:output_type -> types.StringValue
	27, // 54: v1.Backrest.ClearHistory:output_type -> google.protobuf.Empty
	36, // 55: v1.Backrest.PathAutocomplete:output_type -> types.StringList
	14, // 56: v1.Backrest.GetSummaryDashboard:output_type -> v1.SummaryDashboardResponse
	15, // 57: v1.BackrestSyncService.Sync:output_type -> v1.SyncStreamItem
