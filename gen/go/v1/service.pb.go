...
const file_v1_service_proto_rawDesc = "" +
	"\n" +
	"\x10v1/service.proto\x12\x02v1\x1a\x0fv1/config.proto\x1a\x0fv1/restic.proto\x1a\x13v1/operations.proto\x1a\x11types/value.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/api/annotations.proto\"\x8e\x02\n" +
	"\n" +
	"OpSelector\x12\x10\n" +
	"\x03ids\x18\x01 \x03(\x03R\x03ids\x12$\n" +
	"\vinstance_id\x18\x06 \x01(\tH\x00R\n" +
	"instanceId\x88\x01\x01\x12 \n" +
	"\trepo_guid\x18\a \x01(\tH\x01R\brepoGuid\x88\x01\x01\x12\x1c\n" +
	"\aplan_id\x18\x03 \x01(\tH\x02R\x06planId\x88\x01\x01\x12$\n" +
	"\vsnapshot_id\x18\x04 \x01(\tH\x03R\n" +
	"snapshotId\x88\x01\x01\x12\x1c\n" +
	"\aflow_id\x18\x05 \x01(\x03H\x04R\x06flowId\x88\x01\x01B\x0e\n" +
	"\f_instance_idB\f\n" +
	"\n" +
	"_repo_guidB\n" +
	"\n" +
