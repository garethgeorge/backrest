...
const (
	...
	Authentication_GetAuthInfo_FullMethodName  = "/v1.Authentication/GetAuthInfo"
)
...
type AuthenticationClient interface {
	...
	GetAuthInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AuthInfo, error)
}
...
func (c *authenticationClient) GetAuthInfo(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*AuthInfo, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthInfo)
	err := c.cc.Invoke(ctx, Authentication_GetAuthInfo_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthenticationServer interface {
	...
	// prompt for login (e.g. local password form vs. redirect to an OIDC provider)
	// before the user is authenticated.
	GetAuthInfo(context.Context, *emptypb.Empty) (*AuthInfo, error)
...
func (UnimplementedAuthenticationServer) GetAuthInfo(context.Context, *emptypb.Empty) (*AuthInfo, error) {
...
func _Authentication_GetAuthInfo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(emptypb.Empty)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthenticationServer).GetAuthInfo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Authentication_GetAuthInfo_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthenticationServer).GetAuthInfo(ctx, req.(*emptypb.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Authentication_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Authentication_GetAuthInfo_Handler,
		},
	},
