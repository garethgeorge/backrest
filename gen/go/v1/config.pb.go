...
type Config struct {
	...
	Baseurl  string  `protobuf:"bytes,7,opt,name=baseurl,json=urlbase,proto3" json:"baseurl,omitempty"` // base URL for the UI, must be set if using the sync feature.
}
...
func (x *Config) GetBaseurl() string {
	if x != nil {
		return x.Baseurl
	}
	return ""
...
type Repo struct {
	...
	ClientKeys    []*Repo_ClientKey `protobuf:"bytes,11,rep,name=client_keys,json=clientKeys,proto3" json:"client_keys,omitempty"`          // client keys for syncing with other instances.
}
...
func (x *Repo) GetClientKeys() []*Repo_ClientKey {
	if x != nil {
		return x.ClientKeys
	}
	return nil
...
type Repo_ClientKey struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	InstanceId string `protobuf:"bytes,1,opt,name=instance_id,json=instanceId,proto3" json:"instance_id,omitempty"` // annotated instance ID using the key, will be set on first client connection if not present.
	Secret     string `protobuf:"bytes,2,opt,name=secret,proto3" json:"secret,omitempty"`                           // secret used to authenticate with the instance.
}

func (x *Repo_ClientKey) Reset() {
	*x = Repo_ClientKey{}
...
func (x *Repo_ClientKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Repo_ClientKey) ProtoMessage() {}

func (x *Repo_ClientKey) ProtoReflect() protoreflect.Message {
	mi := &file_v1_config_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Repo_ClientKey.ProtoReflect.Descriptor instead.
func (*Repo_ClientKey) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{2, 0}
}

func (x *Repo_ClientKey) GetInstanceId() string {
	if x != nil {
		return x.InstanceId
	}
	return ""
...
func (x *Repo_ClientKey) GetSecret() string {
	if x != nil {
		return x.Secret
	}
	return ""
...
var file_v1_config_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0xcc, 0x01, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x14, 0x0a, 0x05,
	...
	0x52, 0x04, 0x61, 0x75, 0x74, 0x68, 0x12, 0x18, 0x0a, 0x07, 0x62, 0x61, 0x73, 0x65, 0x75, 0x72,
	0x6c, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x75, 0x72, 0x6c, 0x62, 0x61, 0x73, 0x65,
	0x22, 0xca, 0x03, 0x0a, 0x04, 0x52, 0x65, 0x70, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18,
	...
	,
	...
	,
	...
	0x1a, 0xa1, 0x01, 0x0a, 0x07, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x12, 0x1f, 0x0a, 0x0b,
	0x77, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x0a, 0x77, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x55, 0x72, 0x6c, 0x12, 0x2f, 0x0a,
	0x06, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x17, 0x2e,
	0x76, 0x31, 0x2e, 0x48, 0x6f, 0x6f, 0x6b, 0x2e, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x2e,
	...
	0x52, 0x08, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x22, 0x28, 0x0a, 0x06, 0x4d, 0x65,
	...
	0x53, 0x54, 0x10, 0x02, 0x1a, 0x46, 0x0a, 0x07, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x72, 0x64, 0x12,
	...
	0x28, 0x09, 0x52, 0x08, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x1a, 0x7c, 0x0a, 0x06,
	...
	0x6c, 0x65, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x1a, 0x44, 0x0a, 0x05, 0x53, 0x6c,
	...
	0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x22, 0x9c, 0x03, 0x0a, 0x09, 0x43, 0x6f, 0x6e,
	...
	,
...
var file_v1_config_proto_goTypes = []any{
	...
	(*Repo_ClientKey)(nil),                     // 19: v1.Repo.ClientKey
	...
	(*Hook_Healthchecks)(nil),                  // 27: v1.Hook.Healthchecks
}
var file_v1_config_proto_depIdxs = []int32{
	...
	19, // 8: v1.Repo.client_keys:type_name -> v1.Repo.ClientKey
	14, // 9: v1.Plan.schedule:type_name -> v1.Schedule
	11, // 10: v1.Plan.retention:type_name -> v1.RetentionPolicy
	15, // 11: v1.Plan.hooks:type_name -> v1.Hook
	0,  // 12: v1.CommandPrefix.io_nice:type_name -> v1.CommandPrefix.IONiceLevel
	1,  // 13: v1.CommandPrefix.cpu_nice:type_name -> v1.CommandPrefix.CPUNiceLevel
	20, // 14: v1.RetentionPolicy.policy_time_bucketed:type_name -> v1.RetentionPolicy.TimeBucketedCounts
	14, // 15: v1.PrunePolicy.schedule:type_name -> v1.Schedule
	14, // 16: v1.CheckPolicy.schedule:type_name -> v1.Schedule
	2,  // 17: v1.Schedule.clock:type_name -> v1.Schedule.Clock
	3,  // 18: v1.Hook.conditions:type_name -> v1.Hook.Condition
	4,  // 19: v1.Hook.on_error:type_name -> v1.Hook.OnError
	...
	27, // 26: v1.Hook.action_healthchecks:type_name -> v1.Hook.Healthchecks
	17, // 27: v1.Auth.users:type_name -> v1.User
	5,  // 28: v1.Hook.Webhook.method:type_name -> v1.Hook.Webhook.Method
