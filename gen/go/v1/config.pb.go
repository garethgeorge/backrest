...
type Hook_OsNotification_DeliveryMode int32

const (
	Hook_OsNotification_SILENT Hook_OsNotification_DeliveryMode = 0
	Hook_OsNotification_CHIME  Hook_OsNotification_DeliveryMode = 1
)

// Enum value maps for Hook_OsNotification_DeliveryMode.
var (
	Hook_OsNotification_DeliveryMode_name = map[int32]string{
		0: "SILENT",
		1: "CHIME",
	}
	Hook_OsNotification_DeliveryMode_value = map[string]int32{
		"SILENT": 0,
		"CHIME":  1,
	}
)

func (x Hook_OsNotification_DeliveryMode) Enum() *Hook_OsNotification_DeliveryMode {
	p := new(Hook_OsNotification_DeliveryMode)
	*p = x
	return p
}

func (x Hook_OsNotification_DeliveryMode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Hook_OsNotification_DeliveryMode) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_config_proto_enumTypes[6].Descriptor()
}

func (Hook_OsNotification_DeliveryMode) Type() protoreflect.EnumType {
	return &file_v1_config_proto_enumTypes[6]
}

func (x Hook_OsNotification_DeliveryMode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Hook_OsNotification_DeliveryMode.Descriptor instead.
func (Hook_OsNotification_DeliveryMode) EnumDescriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{10, 7, 0}
}
...
func (x *Hook) GetActionOsNotification() *Hook_OsNotification {
	if x, ok := x.GetAction().(*Hook_ActionOsNotification); ok {
		return x.ActionOsNotification
	}
	return nil
}
...
type Hook_ActionOsNotification struct {
	ActionOsNotification *Hook_OsNotification `protobuf:"bytes,107,opt,name=action_os_notification,json=actionOsNotification,proto3,oneof"`
}
...
func (*Hook_ActionOsNotification) isHook_Action() {}
...
type Hook_OsNotification struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	DeliveryMode  Hook_OsNotification_DeliveryMode `protobuf:"varint,3,opt,name=delivery_mode,json=deliveryMode,proto3,enum=v1.Hook_OsNotification_DeliveryMode" json:"delivery_mode,omitempty"`
}

func (x *Hook_OsNotification) Reset() {
	*x = Hook_OsNotification{}
	mi := &file_v1_config_proto_msgTypes[23]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Hook_OsNotification) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Hook_OsNotification) ProtoMessage() {}

func (x *Hook_OsNotification) ProtoReflect() protoreflect.Message {
	mi := &file_v1_config_proto_msgTypes[23]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Hook_OsNotification.ProtoReflect.Descriptor instead.
func (*Hook_OsNotification) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{10, 7}
}

func (x *Hook_OsNotification) GetTemplate() string {
	if x != nil {
		return x.Template
	}
	return ""
...
func (x *Hook_OsNotification) GetTitleTemplate() string {
	if x != nil {
		return x.TitleTemplate
	}
	return ""
...
func (x *Hook_OsNotification) GetDeliveryMode() Hook_OsNotification_DeliveryMode {
	if x != nil {
		return x.DeliveryMode
	}
	return Hook_OsNotification_SILENT
}
...
var file_v1_config_proto_rawDesc = []byte{
	...
	0x10, 0x03, 0x42, 0x0a, 0x0a, 0x08, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x22, 0xe8,
	0x0f, 0x0a, 0x04, 0x48, 0x6f, 0x6f, 0x6b, 0x12, 0x32, 0x0a, 0x0a, 0x63, 0x6f, 0x6e, 0x64, 0x69,
	...
	0x6f, 0x6e, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x12, 0x4f,
	0x0a, 0x16, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x6f, 0x73, 0x5f, 0x6e, 0x6f, 0x74, 0x69,
	0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x18, 0x6b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17,
	0x2e, 0x76, 0x31, 0x2e, 0x48, 0x6f, 0x6f, 0x6b, 0x2e, 0x4f, 0x73, 0x4e, 0x6f, 0x74, 0x69, 0x66,
	0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x48, 0x00, 0x52, 0x14, 0x61, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x4f, 0x73, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x1a,
	...
	0x6d, 0x61, 0x6e, 0x64, 0x1a, 0xa1, 0x01, 0x0a, 0x07, 0x57, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b,
	...
	0x6c, 0x12, 0x2f, 0x0a, 0x06, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x17, 0x2e, 0x76, 0x31, 0x2e, 0x48, 0x6f, 0x6f, 0x6b, 0x2e, 0x57, 0x65, 0x62, 0x68,
	0x6f, 0x6f, 0x6b, 0x2e, 0x4d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x52, 0x06, 0x6d, 0x65, 0x74, 0x68,
	0x6f, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x18, 0x64,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x22, 0x28,
	...
	0x0a, 0x04, 0x50, 0x4f, 0x53, 0x54, 0x10, 0x02, 0x1a, 0x46, 0x0a, 0x07, 0x44, 0x69, 0x73, 0x63,
	...
	0x6c, 0x61, 0x74, 0x65, 0x1a, 0x49, 0x0a, 0x08, 0x53, 0x68, 0x6f, 0x75, 0x74, 0x72, 0x72, 0x72,
	0x12, 0x21, 0x0a, 0x0c, 0x73, 0x68, 0x6f, 0x75, 0x74, 0x72, 0x72, 0x72, 0x5f, 0x75, 0x72, 0x6c,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x73, 0x68, 0x6f, 0x75, 0x74, 0x72, 0x72, 0x72,
	...
	0x4b, 0x0a, 0x0c, 0x48, 0x65, 0x61, 0x6c, 0x74, 0x68, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x12,
	...
	0x28, 0x09, 0x52, 0x08, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x1a, 0xc5, 0x01, 0x0a,
	0x0e, 0x4f, 0x73, 0x4e, 0x6f, 0x74, 0x69, 0x66, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12,
	...
	,
...
var file_v1_config_proto_goTypes = []any{
	...
	(Hook_OsNotification_DeliveryMode)(0),      // 6: v1.Hook.OsNotification.DeliveryMode
	...
	(*Hook_OsNotification)(nil),                // 30: v1.Hook.OsNotification
	(*PublicKey)(nil),                          // 31: v1.PublicKey
}
var file_v1_config_proto_depIdxs = []int32{
	...
	30, // 29: v1.Hook.action_os_notification:type_name -> v1.Hook.OsNotification
	19, // 30: v1.Auth.users:type_name -> v1.User
	31, // 31: v1.Multihost.Peer.public_key:type_name -> v1.PublicKey
	5,  // 32: v1.Hook.Webhook.method:type_name -> v1.Hook.Webhook.Method
	6,  // 33: v1.Hook.OsNotification.delivery_mode:type_name -> v1.Hook.OsNotification.DeliveryMode
