...
func (Hook_Condition) EnumDescriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{12, 0}
}
...
func (Hook_OnError) EnumDescriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{12, 1}
}
...
func (Hook_Webhook_Method) EnumDescriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{12, 1, 0}
}
...
type PublicKey struct {
	...
	Ed25519 string `protobuf:"bytes,1,opt,name=ed25519,json=ed25519pub,proto3" json:"ed25519,omitempty"` // base64 encoded public key
}
...
func (*User) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{14}
}
...
func (*Hook_Discord) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{12, 2}
}
...
func (*Hook_Gotify) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{12, 3}
}
...
func (*Hook_Slack) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{12, 4}
}
...
func (*Hook_Shoutrrr) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{12, 5}
}
...
func (*Hook_Healthchecks) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{12, 6}
}
...
var file_v1_config_proto_goTypes = []any{
	...
	(*PublicKey)(nil),                          // 9: v1.PublicKey
	(*PrivateKey)(nil),                         // 10: v1.PrivateKey
	(*Repo)(nil),                               // 11: v1.Repo
	(*Plan)(nil),                               // 12: v1.Plan
	(*CommandPrefix)(nil),                      // 13: v1.CommandPrefix
	(*RetentionPolicy)(nil),                    // 14: v1.RetentionPolicy
	...
	(*Auth)(nil),                               // 19: v1.Auth
	(*User)(nil),                               // 20: v1.User
	(*HubConfig_InstanceInfo)(nil),             // 21: v1.HubConfig.InstanceInfo
	(*Multihost_Peer)(nil),                     // 22: v1.Multihost.Peer
...
var file_v1_config_proto_depIdxs = []int32{
	21, // 0: v1.HubConfig.instances:type_name -> v1.HubConfig.InstanceInfo
	11, // 1: v1.Config.repos:type_name -> v1.Repo
	12, // 2: v1.Config.plans:type_name -> v1.Plan
	19, // 3: v1.Config.auth:type_name -> v1.Auth
	8,  // 4: v1.Config.multihost:type_name -> v1.Multihost
	22, // 5: v1.Multihost.known_hosts:type_name -> v1.Multihost.Peer
	22, // 6: v1.Multihost.authorized_clients:type_name -> v1.Multihost.Peer
	15, // 7: v1.Repo.prune_policy:type_name -> v1.PrunePolicy
	16, // 8: v1.Repo.check_policy:type_name -> v1.CheckPolicy
	18, // 9: v1.Repo.hooks:type_name -> v1.Hook
	13, // 10: v1.Repo.command_prefix:type_name -> v1.CommandPrefix
	17, // 11: v1.Plan.schedule:type_name -> v1.Schedule
	14, // 12: v1.Plan.retention:type_name -> v1.RetentionPolicy
	18, // 13: v1.Plan.hooks:type_name -> v1.Hook
	...
	23, // 16: v1.RetentionPolicy.policy_time_bucketed:type_name -> v1.RetentionPolicy.TimeBucketedCounts
	17, // 17: v1.PrunePolicy.schedule:type_name -> v1.Schedule
	17, // 18: v1.CheckPolicy.schedule:type_name -> v1.Schedule
	...
	24, // 22: v1.Hook.action_command:type_name -> v1.Hook.Command
	25, // 23: v1.Hook.action_webhook:type_name -> v1.Hook.Webhook
	26, // 24: v1.Hook.action_discord:type_name -> v1.Hook.Discord
	27, // 25: v1.Hook.action_gotify:type_name -> v1.Hook.Gotify
	28, // 26: v1.Hook.action_slack:type_name -> v1.Hook.Slack
	29, // 27: v1.Hook.action_shoutrrr:type_name -> v1.Hook.Shoutrrr
	30, // 28: v1.Hook.action_healthchecks:type_name -> v1.Hook.Healthchecks
	20, // 29: v1.Auth.users:type_name -> v1.User
	9,  // 30: v1.Multihost.Peer.public_key:type_name -> v1.PublicKey
...
func file_v1_config_proto_init() {
	...
	file_v1_config_proto_msgTypes[14].OneofWrappers = []any{
