...
type PrunePolicy struct {
	...
	//
	//	*PrunePolicy_MaxUnusedPercent
	//	*PrunePolicy_MaxUnusedBytes
	Policy isPrunePolicy_Policy `protobuf_oneof:"policy"`
}
...
func (m *PrunePolicy) GetPolicy() isPrunePolicy_Policy {
	if m != nil {
		return m.Policy
	}
	return nil
...
func (x *PrunePolicy) GetMaxUnusedPercent() int32 {
	if x, ok := x.GetPolicy().(*PrunePolicy_MaxUnusedPercent); ok {
...
func (x *PrunePolicy) GetMaxUnusedBytes() int32 {
	if x, ok := x.GetPolicy().(*PrunePolicy_MaxUnusedBytes); ok {
		return x.MaxUnusedBytes
	}
	return 0
}

type isPrunePolicy_Policy interface {
	isPrunePolicy_Policy()
}

type PrunePolicy_MaxUnusedPercent struct {
	MaxUnusedPercent int32 `protobuf:"varint,100,opt,name=max_unused_percent,json=maxUnusedPercent,proto3,oneof"` // max percentage of repo size that can be unused before prune is run.
}

type PrunePolicy_MaxUnusedBytes struct {
	MaxUnusedBytes int32 `protobuf:"varint,101,opt,name=max_unused_bytes,json=maxUnusedBytes,proto3,oneof"` // max number of bytes that can be unused before prune is run.
}

func (*PrunePolicy_MaxUnusedPercent) isPrunePolicy_Policy() {}

func (*PrunePolicy_MaxUnusedBytes) isPrunePolicy_Policy() {}
...
var file_v1_config_proto_rawDesc = []byte{
	...
	0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0xa1, 0x01, 0x0a, 0x0b, 0x50, 0x72, 0x75, 0x6e,
	...
	0x79, 0x44, 0x61, 0x79, 0x73, 0x12, 0x2e, 0x0a, 0x12, 0x6d, 0x61, 0x78, 0x5f, 0x75, 0x6e, 0x75,
	0x73, 0x65, 0x64, 0x5f, 0x70, 0x65, 0x72, 0x63, 0x65, 0x6e, 0x74, 0x18, 0x64, 0x20, 0x01, 0x28,
	0x05, 0x48, 0x00, 0x52, 0x10, 0x6d, 0x61, 0x78, 0x55, 0x6e, 0x75, 0x73, 0x65, 0x64, 0x50, 0x65,
	0x72, 0x63, 0x65, 0x6e, 0x74, 0x12, 0x2a, 0x0a, 0x10, 0x6d, 0x61, 0x78, 0x5f, 0x75, 0x6e, 0x75,
	0x73, 0x65, 0x64, 0x5f, 0x62, 0x79, 0x74, 0x65, 0x73, 0x18, 0x65, 0x20, 0x01, 0x28, 0x05, 0x48,
	0x00, 0x52, 0x0e, 0x6d, 0x61, 0x78, 0x55, 0x6e, 0x75, 0x73, 0x65, 0x64, 0x42, 0x79, 0x74, 0x65,
	0x73, 0x42, 0x08, 0x0a, 0x06, 0x70, 0x6f, 0x6c, 0x69, 0x63, 0x79, 0x42, 0x2e, 0x5a, 0x2c, 0x67,
...
func file_v1_config_proto_init() {
	...
	file_v1_config_proto_msgTypes[4].OneofWrappers = []interface{}{
		(*PrunePolicy_MaxUnusedPercent)(nil),
		(*PrunePolicy_MaxUnusedBytes)(nil),
	}
	type x struct{}
