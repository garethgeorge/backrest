...
const (
	...
	Peer_PERMISSION_CONNECT Peer_Permission = 1 // connect to the instance.
)
...
var file_v1_config_proto_rawDesc = []byte{
	...
	0x05, 0x70, 0x65, 0x65, 0x72, 0x73, 0x22, 0x9b, 0x02, 0x0a, 0x04, 0x50, 0x65, 0x65, 0x72, 0x12,
	...
	,
	...
	0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x22, 0xd9, 0x02, 0x0a, 0x04, 0x50, 0x6c, 0x61, 0x6e, 0x12,
...
var file_v1_config_proto_depIdxs = []int32{
	...
	21, // 5: v1.Peer.permissions:type_name -> v1.Peer.ScopedPermission
	14, // 6: v1.Repo.prune_policy:type_name -> v1.PrunePolicy
	15, // 7: v1.Repo.check_policy:type_name -> v1.CheckPolicy
	17, // 8: v1.Repo.hooks:type_name -> v1.Hook
	12, // 9: v1.Repo.command_prefix:type_name -> v1.CommandPrefix
	16, // 10: v1.Plan.schedule:type_name -> v1.Schedule
	13, // 11: v1.Plan.retention:type_name -> v1.RetentionPolicy
	17, // 12: v1.Plan.hooks:type_name -> v1.Hook
	1,  // 13: v1.CommandPrefix.io_nice:type_name -> v1.CommandPrefix.IONiceLevel
	2,  // 14: v1.CommandPrefix.cpu_nice:type_name -> v1.CommandPrefix.CPUNiceLevel
	22, // 15: v1.RetentionPolicy.policy_time_bucketed:type_name -> v1.RetentionPolicy.TimeBucketedCounts
	16, // 16: v1.PrunePolicy.schedule:type_name -> v1.Schedule
	16, // 17: v1.CheckPolicy.schedule:type_name -> v1.Schedule
	3,  // 18: v1.Schedule.clock:type_name -> v1.Schedule.Clock
	4,  // 19: v1.Hook.conditions:type_name -> v1.Hook.Condition
	5,  // 20: v1.Hook.on_error:type_name -> v1.Hook.OnError
	23, // 21: v1.Hook.action_command:type_name -> v1.Hook.Command
	24, // 22: v1.Hook.action_webhook:type_name -> v1.Hook.Webhook
	25, // 23: v1.Hook.action_discord:type_name -> v1.Hook.Discord
	26, // 24: v1.Hook.action_gotify:type_name -> v1.Hook.Gotify
	27, // 25: v1.Hook.action_slack:type_name -> v1.Hook.Slack
	28, // 26: v1.Hook.action_shoutrrr:type_name -> v1.Hook.Shoutrrr
	29, // 27: v1.Hook.action_healthchecks:type_name -> v1.Hook.Healthchecks
	19, // 28: v1.Auth.users:type_name -> v1.User
	0,  // 29: v1.Peer.ScopedPermission.perm:type_name -> v1.Peer.Permission
	6,  // 30: v1.Hook.Webhook.method:type_name -> v1.Hook.Webhook.Method
