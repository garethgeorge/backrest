...
type Peer_Permission int32

const (
	Peer_PERMISSION_UNKNOWN Peer_Permission = 0
	Peer_PERMISSION_CONNECT Peer_Permission = 1
)

// Enum value maps for Peer_Permission.
var (
	Peer_Permission_name = map[int32]string{
		0: "PERMISSION_UNKNOWN",
		1: "PERMISSION_CONNECT",
	}
	Peer_Permission_value = map[string]int32{
		"PERMISSION_UNKNOWN": 0,
		"PERMISSION_CONNECT": 1,
	}
)

func (x Peer_Permission) Enum() *Peer_Permission {
	p := new(Peer_Permission)
	*p = x
	return p
}

func (x Peer_Permission) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (Peer_Permission) Descriptor() protoreflect.EnumDescriptor {
	return file_v1_config_proto_enumTypes[0].Descriptor()
}

func (Peer_Permission) Type() protoreflect.EnumType {
	return &file_v1_config_proto_enumTypes[0]
}

func (x Peer_Permission) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use Peer_Permission.Descriptor instead.
func (Peer_Permission) EnumDescriptor() ([]byte, []int) {
...
type Config struct {
	...
	Peers    *Peer   `protobuf:"bytes,8,opt,name=peers,proto3" json:"peers,omitempty"`
}
...
type Peer struct {
	...
	PublicKeyPem      string                   `protobuf:"bytes,2,opt,name=public_key_pem,json=publicKeyPem,proto3" json:"public_key_pem,omitempty"`                                              // PEM encoded public key.
	GlobalPermissions []Peer_Permission        `protobuf:"varint,4,rep,packed,name=global_permissions,json=globalPermissions,proto3,enum=v1.Peer_Permission" json:"global_permissions,omitempty"` // global permissions granted to the peer.
	Permissions       []*Peer_ScopedPermission `protobuf:"bytes,3,rep,name=permissions,proto3" json:"permissions,omitempty"`                                                                      // permissions granted to the peer.
}
...
func (x *Peer) GetInstanceId() string {
	if x != nil {
		return x.InstanceId
	}
	return ""
...
func (x *Peer) GetPublicKeyPem() string {
	if x != nil {
...
func (x *Peer) GetGlobalPermissions() []Peer_Permission {
	if x != nil {
...
func (x *Peer) GetPermissions() []*Peer_ScopedPermission {
	if x != nil {
...
type Peer_ScopedPermission struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Scope string          `protobuf:"bytes,1,opt,name=scope,proto3" json:"scope,omitempty"`                        // scope of the permission e.g. repo:<repo ID>
	Perm  Peer_Permission `protobuf:"varint,2,opt,name=perm,proto3,enum=v1.Peer_Permission" json:"perm,omitempty"` // permission granted.
}

func (x *Peer_ScopedPermission) Reset() {
	*x = Peer_ScopedPermission{}
	mi := &file_v1_config_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Peer_ScopedPermission) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Peer_ScopedPermission) ProtoMessage() {}

func (x *Peer_ScopedPermission) ProtoReflect() protoreflect.Message {
	mi := &file_v1_config_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Peer_ScopedPermission.ProtoReflect.Descriptor instead.
func (*Peer_ScopedPermission) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{2, 0}
}

func (x *Peer_ScopedPermission) GetScope() string {
	if x != nil {
		return x.Scope
	}
	return ""
...
func (x *Peer_ScopedPermission) GetPerm() Peer_Permission {
	if x != nil {
		return x.Perm
	}
	return Peer_PERMISSION_UNKNOWN
}
...
var file_v1_config_proto_rawDesc = []byte{
	...
	0x74, 0x22, 0xd2, 0x01, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x14, 0x0a, 0x05,
	...
	0x52, 0x04, 0x61, 0x75, 0x74, 0x68, 0x12, 0x1e, 0x0a, 0x05, 0x70, 0x65, 0x65, 0x72, 0x73, 0x18,
	0x08, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x65, 0x65, 0x72, 0x52,
	0x05, 0x70, 0x65, 0x65, 0x72, 0x73, 0x22, 0xdf, 0x02, 0x0a, 0x04, 0x50, 0x65, 0x65, 0x72, 0x12,
	...
	,
	...
	,
	...
	0x6d, 0x61, 0x6e, 0x64, 0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x22, 0xd9, 0x02, 0x0a, 0x04, 0x50,
	...
	,
	...
	,
	...
	,
	...
	0x02, 0x1a, 0x46, 0x0a, 0x07, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x1f, 0x0a, 0x0b,
	...
	0x08, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x1a, 0x7c, 0x0a, 0x06, 0x47, 0x6f, 0x74,
	0x69, 0x66, 0x79, 0x12, 0x19, 0x0a, 0x08, 0x62, 0x61, 0x73, 0x65, 0x5f, 0x75, 0x72, 0x6c, 0x18,
	...
	0x6f, 0x6b, 0x65, 0x6e, 0x12, 0x1a, 0x0a, 0x08, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65,
	0x18, 0x64, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65,
	0x12, 0x25, 0x0a, 0x0e, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x5f, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61,
	0x74, 0x65, 0x18, 0x65, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x74, 0x69, 0x74, 0x6c, 0x65, 0x54,
	0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x1a, 0x44, 0x0a, 0x05, 0x53, 0x6c, 0x61, 0x63, 0x6b,
	...
	0x01, 0x28, 0x09, 0x52, 0x08, 0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x1a, 0x49, 0x0a,
	0x08, 0x53, 0x68, 0x6f, 0x75, 0x74, 0x72, 0x72, 0x72, 0x12, 0x21, 0x0a, 0x0c, 0x73, 0x68, 0x6f,
	0x75, 0x74, 0x72, 0x72, 0x72, 0x5f, 0x75, 0x72, 0x6c, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x0b, 0x73, 0x68, 0x6f, 0x75, 0x74, 0x72, 0x72, 0x72, 0x55, 0x72, 0x6c, 0x12, 0x1a, 0x0a, 0x08,
	0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x08,
	0x74, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x1a, 0x4b, 0x0a, 0x0c, 0x48, 0x65, 0x61, 0x6c,
	0x74, 0x68, 0x63, 0x68, 0x65, 0x63, 0x6b, 0x73, 0x12, 0x1f, 0x0a, 0x0b, 0x77, 0x65, 0x62, 0x68,
	...
	0x70, 0x6c, 0x61, 0x74, 0x65, 0x22, 0x9c, 0x03, 0x0a, 0x09, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74,
	...
	,
	...
	,
...
var file_v1_config_proto_goTypes = []any{
	(Peer_Permission)(0),                       // 0: v1.Peer.Permission
	...
	(*Peer_ScopedPermission)(nil),              // 21: v1.Peer.ScopedPermission
...
var file_v1_config_proto_depIdxs = []int32{
	...
	9,  // 4: v1.Config.peers:type_name -> v1.Peer
	0,  // 5: v1.Peer.global_permissions:type_name -> v1.Peer.Permission
	21, // 6: v1.Peer.permissions:type_name -> v1.Peer.ScopedPermission
	14, // 7: v1.Repo.prune_policy:type_name -> v1.PrunePolicy
	15, // 8: v1.Repo.check_policy:type_name -> v1.CheckPolicy
	17, // 9: v1.Repo.hooks:type_name -> v1.Hook
	12, // 10: v1.Repo.command_prefix:type_name -> v1.CommandPrefix
	16, // 11: v1.Plan.schedule:type_name -> v1.Schedule
	13, // 12: v1.Plan.retention:type_name -> v1.RetentionPolicy
	17, // 13: v1.Plan.hooks:type_name -> v1.Hook
	...
	22, // 16: v1.RetentionPolicy.policy_time_bucketed:type_name -> v1.RetentionPolicy.TimeBucketedCounts
	16, // 17: v1.PrunePolicy.schedule:type_name -> v1.Schedule
	16, // 18: v1.CheckPolicy.schedule:type_name -> v1.Schedule
	...
	23, // 22: v1.Hook.action_command:type_name -> v1.Hook.Command
	24, // 23: v1.Hook.action_webhook:type_name -> v1.Hook.Webhook
	25, // 24: v1.Hook.action_discord:type_name -> v1.Hook.Discord
	26, // 25: v1.Hook.action_gotify:type_name -> v1.Hook.Gotify
	27, // 26: v1.Hook.action_slack:type_name -> v1.Hook.Slack
	28, // 27: v1.Hook.action_shoutrrr:type_name -> v1.Hook.Shoutrrr
	29, // 28: v1.Hook.action_healthchecks:type_name -> v1.Hook.Healthchecks
	19, // 29: v1.Auth.users:type_name -> v1.User
	0,  // 30: v1.Peer.ScopedPermission.perm:type_name -> v1.Peer.Permission
	6,  // 31: v1.Hook.Webhook.method:type_name -> v1.Hook.Webhook.Method
