...
type Multihost_Identity struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	PublicKey  *PublicKey  `protobuf:"bytes,1,opt,name=public_key,json=publicKey,proto3" json:"public_key,omitempty"`    // public key of the instance.
	PrivateKey *PrivateKey `protobuf:"bytes,2,opt,name=private_key,json=privateKey,proto3" json:"private_key,omitempty"` // private key of the instance.
}

func (x *Multihost_Identity) Reset() {
	*x = Multihost_Identity{}
	mi := &file_v1_config_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *Multihost_Identity) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Multihost_Identity) ProtoMessage() {}

func (x *Multihost_Identity) ProtoReflect() protoreflect.Message {
	mi := &file_v1_config_proto_msgTypes[15]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Multihost_Identity.ProtoReflect.Descriptor instead.
func (*Multihost_Identity) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{2, 1}
}

func (x *Multihost_Identity) GetPublicKey() *PublicKey {
	if x != nil {
		return x.PublicKey
	}
	return nil
...
func (x *Multihost_Identity) GetPrivateKey() *PrivateKey {
	if x != nil {
		return x.PrivateKey
	}
	return nil
...
var file_v1_config_proto_rawDesc = []byte{
	...
	0x99, 0x03, 0x0a, 0x09, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x68, 0x6f, 0x73, 0x74, 0x12, 0x33, 0x0a,
	...
	0x1a, 0x69, 0x0a, 0x08, 0x49, 0x64, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x2c, 0x0a, 0x0a,
	0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x5f, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b,
	0x32, 0x0d, 0x2e, 0x76, 0x31, 0x2e, 0x50, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x52,
	0x09, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x4b, 0x65, 0x79, 0x12, 0x2f, 0x0a, 0x0b, 0x70, 0x72,
	...
	0x0a, 0x70, 0x72, 0x69, 0x76, 0x61, 0x74, 0x65, 0x4b, 0x65, 0x79, 0x22, 0xbd, 0x03, 0x0a, 0x04,
...
var file_v1_config_proto_goTypes = []any{
	...
	(*Multihost_Identity)(nil),                 // 21: v1.Multihost.Identity
...
var file_v1_config_proto_depIdxs = []int32{
	...
	30, // 30: v1.Multihost.Peer.public_key:type_name -> v1.PublicKey
	30, // 31: v1.Multihost.Identity.public_key:type_name -> v1.PublicKey
	31, // 32: v1.Multihost.Identity.private_key:type_name -> v1.PrivateKey
	5,  // 33: v1.Hook.Webhook.method:type_name -> v1.Hook.Webhook.Method
