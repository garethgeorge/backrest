...
func (x *Hook) GetActionPushover() *Hook_Pushover {
	if x != nil {
		if x, ok := x.Action.(*Hook_ActionPushover); ok {
			return x.ActionPushover
		}
	}
	return nil
}
...
type Hook_ActionPushover struct {
	ActionPushover *Hook_Pushover `protobuf:"bytes,108,opt,name=action_pushover,json=actionPushover,proto3,oneof"`
}
...
func (*Hook_ActionPushover) isHook_Action() {}
...
type Hook_Pushover struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Token         string                 `protobuf:"bytes,1,opt,name=token,proto3" json:"token,omitempty"`                                        // application API token from pushover.net/apps
	UserKey       string                 `protobuf:"bytes,2,opt,name=user_key,json=userKey,proto3" json:"user_key,omitempty"`                     // user or group key from pushover.net/dashboard
	Template      string                 `protobuf:"bytes,100,opt,name=template,proto3" json:"template,omitempty"`                                // template for the message body.
	TitleTemplate string                 `protobuf:"bytes,101,opt,name=title_template,json=titleTemplate,proto3" json:"title_template,omitempty"` // template for the message title.
	Priority      int32                  `protobuf:"varint,102,opt,name=priority,proto3" json:"priority,omitempty"`                               // message priority: -2 (lowest) to 2 (emergency)
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *Hook_Pushover) Reset() {
	*x = Hook_Pushover{}
...
func (x *Hook_Pushover) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Hook_Pushover) ProtoMessage() {}

func (x *Hook_Pushover) ProtoReflect() protoreflect.Message {
	mi := &file_v1_config_proto_msgTypes[25]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Hook_Pushover.ProtoReflect.Descriptor instead.
func (*Hook_Pushover) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{10, 8}
}

func (x *Hook_Pushover) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *Hook_Pushover) GetUserKey() string {
	if x != nil {
		return x.UserKey
	}
	return ""
...
func (x *Hook_Pushover) GetTemplate() string {
	if x != nil {
		return x.Template
	}
	return ""
...
func (x *Hook_Pushover) GetTitleTemplate() string {
	if x != nil {
		return x.TitleTemplate
	}
	return ""
...
func (x *Hook_Pushover) GetPriority() int32 {
	if x != nil {
		return x.Priority
	}
	return 0
...
const file_v1_config_proto_rawDesc = "" +
	...
	"\x0faction_pushover\x18l \x01(\v2\x11.v1.Hook.PushoverH\x00R\x0eactionPushover\x1a#\n" +
	"\aCommand\x12\x18\n" +
	...
	"\btemplate\x18\x03 \x01(\tR\btemplate\x1a\x9a\x01\n" +
	"\bPushover\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x19\n" +
	"\buser_key\x18\x02 \x01(\tR\auserKey\x12\x1a\n" +
	"\btemplate\x18d \x01(\tR\btemplate\x12%\n" +
	"\x0etitle_template\x18e \x01(\tR\rtitleTemplate\x12\x1a\n" +
	"\bpriority\x18f \x01(\x05R\bpriority\"\xf5\x03\n" +
	"\tCondition\x12\x15\n" +
...
var file_v1_config_proto_goTypes = []any{
	...
	(*Hook_Pushover)(nil),                      // 32: v1.Hook.Pushover
...
var file_v1_config_proto_depIdxs = []int32{
	...
	32, // 34: v1.Hook.action_pushover:type_name -> v1.Hook.Pushover
	19, // 35: v1.Auth.users:type_name -> v1.User
	22, // 36: v1.Multihost.Peer.permissions:type_name -> v1.Multihost.Permission
	22, // 37: v1.Multihost.PairingToken.permissions:type_name -> v1.Multihost.Permission
