...
type Schedule struct {
	...
	//	*Schedule_CronSinceLastRun
	//	*Schedule_MinHoursSinceLastRun
	//	*Schedule_MinDaysSinceLastRun
...
func (x *Schedule) GetCronSinceLastRun() string {
	if x, ok := x.GetSchedule().(*Schedule_CronSinceLastRun); ok {
		return x.CronSinceLastRun
	}
	return ""
}

func (x *Schedule) GetMinHoursSinceLastRun() int32 {
	if x, ok := x.GetSchedule().(*Schedule_MinHoursSinceLastRun); ok {
		return x.MinHoursSinceLastRun
	}
	return 0
}

func (x *Schedule) GetMinDaysSinceLastRun() int32 {
	if x, ok := x.GetSchedule().(*Schedule_MinDaysSinceLastRun); ok {
		return x.MinDaysSinceLastRun
	}
	return 0
}
...
type Schedule_CronSinceLastRun struct {
	CronSinceLastRun string `protobuf:"bytes,100,opt,name=cronSinceLastRun,proto3,oneof"` // cron expression to run since the last run.
}

type Schedule_MinHoursSinceLastRun struct {
	MinHoursSinceLastRun int32 `protobuf:"varint,101,opt,name=minHoursSinceLastRun,proto3,oneof"` // max hours since the last run.
}

type Schedule_MinDaysSinceLastRun struct {
	MinDaysSinceLastRun int32 `protobuf:"varint,102,opt,name=minDaysSinceLastRun,proto3,oneof"` // max days since the last run.
}
...
func (*Schedule_CronSinceLastRun) isSchedule_Schedule() {}

func (*Schedule_MinHoursSinceLastRun) isSchedule_Schedule() {}

func (*Schedule_MinDaysSinceLastRun) isSchedule_Schedule() {}
...
var file_v1_config_proto_rawDesc = []byte{
	...
	0x6e, 0x64, 0x50, 0x72, 0x65, 0x66, 0x69, 0x78, 0x22, 0xd3, 0x02, 0x0a, 0x04, 0x50, 0x6c, 0x61,
	...
	0x74, 0x42, 0x06, 0x0a, 0x04, 0x6d, 0x6f, 0x64, 0x65, 0x22, 0xc0, 0x02, 0x0a, 0x08, 0x53, 0x63,
	...
	,
	...
	0x72, 0x72, 0x1a, 0x23, 0x0a, 0x07, 0x43, 0x6f, 0x6d, 0x6d, 0x61, 0x6e, 0x64, 0x12, 0x18, 0x0a,
	...
	0x74, 0x65, 0x22, 0xfc, 0x02, 0x0a, 0x09, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x55, 0x43, 0x43, 0x45, 0x53, 0x53, 0x10, 0x06, 0x12, 0x19, 0x0a, 0x15, 0x43, 0x4f, 0x4e, 0x44,
...
func file_v1_config_proto_init() {
	...
	file_v1_config_proto_msgTypes[8].OneofWrappers = []interface{}{
		...
		(*Schedule_CronSinceLastRun)(nil),
		(*Schedule_MinHoursSinceLastRun)(nil),
		(*Schedule_MinDaysSinceLastRun)(nil),
	}
