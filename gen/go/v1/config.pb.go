...
const (
	...
	Hook_CONDITION_BACKUP_START   Hook_Condition = 1
	Hook_CONDITION_BACKUP_END     Hook_Condition = 2
	Hook_CONDITION_BACKUP_FAILED  Hook_Condition = 3
	Hook_CONDITION_BACKUP_SUCCESS Hook_Condition = 4
)
...
var (
	Hook_Condition_name = map[int32]string{
		...
		3: "CONDITION_BACKUP_FAILED",
		4: "CONDITION_BACKUP_SUCCESS",
	}
	Hook_Condition_value = map[string]int32{
		"CONDITION_UNKNOWN":        0,
		"CONDITION_BACKUP_START":   1,
		"CONDITION_BACKUP_END":     2,
		"CONDITION_BACKUP_FAILED":  3,
		"CONDITION_BACKUP_SUCCESS": 4,
	}
)
...
type Repo struct {
	...
	PreBackupHooks  []*Hook      `protobuf:"bytes,7,rep,name=pre_backup_hooks,json=preBackupHooks,proto3" json:"pre_backup_hooks,omitempty"`    // hooks to run before backup.
	PostBackupHooks []*Hook      `protobuf:"bytes,8,rep,name=post_backup_hooks,json=postBackupHooks,proto3" json:"post_backup_hooks,omitempty"` // hooks to run after backup.
}
...
func (x *Repo) GetPreBackupHooks() []*Hook {
	if x != nil {
		return x.PreBackupHooks
	}
	return nil
}

func (x *Repo) GetPostBackupHooks() []*Hook {
	if x != nil {
		return x.PostBackupHooks
	}
	return nil
}
...
func (x *Hook) GetCommand() string {
	if x, ok := x.GetHook().(*Hook_Command); ok {
		return x.Command
	}
	return ""
}
...
var file_v1_config_proto_rawDesc = []byte{
	...
	0x73, 0x65, 0x72, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x22, 0x8a, 0x02, 0x0a, 0x04, 0x52,
	...
	0x10, 0x70, 0x72, 0x65, 0x5f, 0x62, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x5f, 0x68, 0x6f, 0x6f, 0x6b,
	0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x76, 0x31, 0x2e, 0x48, 0x6f, 0x6f,
	0x6b, 0x52, 0x0e, 0x70, 0x72, 0x65, 0x42, 0x61, 0x63, 0x6b, 0x75, 0x70, 0x48, 0x6f, 0x6f, 0x6b,
	0x73, 0x12, 0x34, 0x0a, 0x11, 0x70, 0x6f, 0x73, 0x74, 0x5f, 0x62, 0x61, 0x63, 0x6b, 0x75, 0x70,
	0x5f, 0x68, 0x6f, 0x6f, 0x6b, 0x73, 0x18, 0x08, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x08, 0x2e, 0x76,
	0x31, 0x2e, 0x48, 0x6f, 0x6f, 0x6b, 0x52, 0x0f, 0x70, 0x6f, 0x73, 0x74, 0x42, 0x61, 0x63, 0x6b,
	0x75, 0x70, 0x48, 0x6f, 0x6f, 0x6b, 0x73, 0x22, 0xa3, 0x01, 0x0a, 0x04, 0x50, 0x6c, 0x61, 0x6e,
	...
	0x63, 0x6c, 0x75, 0x64, 0x65, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x63, 0x72, 0x6f, 0x6e, 0x18, 0x06,
	...
	,
	...
	0x6f, 0x6e, 0x22, 0x93, 0x01, 0x0a, 0x0b, 0x50, 0x72, 0x75, 0x6e, 0x65, 0x50, 0x6f, 0x6c, 0x69,
	...
	0x73, 0x65, 0x64, 0x42, 0x79, 0x74, 0x65, 0x73, 0x22, 0x51, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72,
	...
	0x0a, 0x0a, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x22, 0xf4, 0x01, 0x0a, 0x04,
	...
	0x6e, 0x64, 0x69, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x1a, 0x0a, 0x07, 0x63, 0x6f, 0x6d, 0x6d,
	0x61, 0x6e, 0x64, 0x18, 0x64, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x07, 0x63, 0x6f, 0x6d,
	0x6d, 0x61, 0x6e, 0x64, 0x22, 0x93, 0x01, 0x0a, 0x09, 0x43, 0x6f, 0x6e, 0x64, 0x69, 0x74, 0x69,
	...
	0x44, 0x49, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x42, 0x41, 0x43, 0x4b, 0x55, 0x50, 0x5f, 0x53, 0x54,
	0x41, 0x52, 0x54, 0x10, 0x01, 0x12, 0x18, 0x0a, 0x14, 0x43, 0x4f, 0x4e, 0x44, 0x49, 0x54, 0x49,
	0x4f, 0x4e, 0x5f, 0x42, 0x41, 0x43, 0x4b, 0x55, 0x50, 0x5f, 0x45, 0x4e, 0x44, 0x10, 0x02, 0x12,
	0x1b, 0x0a, 0x17, 0x43, 0x4f, 0x4e, 0x44, 0x49, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x42, 0x41, 0x43,
	0x4b, 0x55, 0x50, 0x5f, 0x46, 0x41, 0x49, 0x4c, 0x45, 0x44, 0x10, 0x03, 0x12, 0x1c, 0x0a, 0x18,
	0x43, 0x4f, 0x4e, 0x44, 0x49, 0x54, 0x49, 0x4f, 0x4e, 0x5f, 0x42, 0x41, 0x43, 0x4b, 0x55, 0x50,
	0x5f, 0x53, 0x55, 0x43, 0x43, 0x45, 0x53, 0x53, 0x10, 0x04, 0x42, 0x06, 0x0a, 0x04, 0x68, 0x6f,
...
var file_v1_config_proto_depIdxs = []int32{
	...
	7, // 4: v1.Repo.pre_backup_hooks:type_name -> v1.Hook
	7, // 5: v1.Repo.post_backup_hooks:type_name -> v1.Hook
	4, // 6: v1.Plan.retention:type_name -> v1.RetentionPolicy
