...
type Config struct {
	...
	HubOptions *HubOptions `protobuf:"bytes,7,opt,name=hub_options,json=hubOptions,proto3" json:"hub_options,omitempty"`
}
...
func (x *Config) GetHubOptions() *HubOptions {
	if x != nil {
		return x.HubOptions
	}
	return nil
...
type HubOptions struct {
	...
	// Types that are assignable to Hub:
	//
	//	*HubOptions_Client_
	//	*HubOptions_Server_
	Hub isHubOptions_Hub `protobuf_oneof:"hub"`
}

func (x *HubOptions) Reset() {
	*x = HubOptions{}
	if protoimpl.UnsafeEnabled {
...
func (x *HubOptions) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HubOptions) ProtoMessage() {}

func (x *HubOptions) ProtoReflect() protoreflect.Message {
	mi := &file_v1_config_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HubOptions.ProtoReflect.Descriptor instead.
func (*HubOptions) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{1}
}

func (m *HubOptions) GetHub() isHubOptions_Hub {
	if m != nil {
		return m.Hub
	}
	return nil
...
func (x *HubOptions) GetClient() *HubOptions_Client {
	if x, ok := x.GetHub().(*HubOptions_Client_); ok {
		return x.Client
	}
	return nil
}

func (x *HubOptions) GetServer() *HubOptions_Server {
	if x, ok := x.GetHub().(*HubOptions_Server_); ok {
		return x.Server
	}
	return nil
}

type isHubOptions_Hub interface {
	isHubOptions_Hub()
}

type HubOptions_Client_ struct {
	Client *HubOptions_Client `protobuf:"bytes,1,opt,name=client,proto3,oneof"`
}

type HubOptions_Server_ struct {
	Server *HubOptions_Server `protobuf:"bytes,2,opt,name=server,proto3,oneof"`
}

func (*HubOptions_Client_) isHubOptions_Hub() {}

func (*HubOptions_Server_) isHubOptions_Hub() {}
...
type PeerOptions struct {
	...
	Instance     string `protobuf:"bytes,1,opt,name=instance,proto3" json:"instance,omitempty"`                             // instance ID for the peer.
	SharedSecret string `protobuf:"bytes,2,opt,name=shared_secret,json=sharedSecret,proto3" json:"shared_secret,omitempty"` // shared secret for the peer.
}

func (x *PeerOptions) Reset() {
	*x = PeerOptions{}
	if protoimpl.UnsafeEnabled {
...
func (x *PeerOptions) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*PeerOptions) ProtoMessage() {}

func (x *PeerOptions) ProtoReflect() protoreflect.Message {
	mi := &file_v1_config_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use PeerOptions.ProtoReflect.Descriptor instead.
func (*PeerOptions) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{2}
}

func (x *PeerOptions) GetInstance() string {
	if x != nil {
		return x.Instance
	}
	return ""
...
func (x *PeerOptions) GetSharedSecret() string {
	if x != nil {
...
type Plan struct {
	...
	Instance string `protobuf:"bytes,13,opt,name=instance,proto3" json:"instance,omitempty"` // (optional) instance ID for the plan, used only with the hub.
...
func (x *Plan) GetInstance() string {
	if x != nil {
		return x.Instance
	}
	return ""
...
type HubOptions_Client struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Address      string `protobuf:"bytes,1,opt,name=address,proto3" json:"address,omitempty"`                               // address of the hub.
	SharedSecret string `protobuf:"bytes,2,opt,name=shared_secret,json=sharedSecret,proto3" json:"shared_secret,omitempty"` // shared secret for the client.
}

func (x *HubOptions_Client) Reset() {
	*x = HubOptions_Client{}
	if protoimpl.UnsafeEnabled {
...
func (x *HubOptions_Client) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HubOptions_Client) ProtoMessage() {}

func (x *HubOptions_Client) ProtoReflect() protoreflect.Message {
	mi := &file_v1_config_proto_msgTypes[13]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HubOptions_Client.ProtoReflect.Descriptor instead.
func (*HubOptions_Client) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{1, 0}
}

func (x *HubOptions_Client) GetAddress() string {
	if x != nil {
		return x.Address
	}
	return ""
...
func (x *HubOptions_Client) GetSharedSecret() string {
	if x != nil {
		return x.SharedSecret
	}
	return ""
...
type HubOptions_Server struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	Peers []*PeerOptions `protobuf:"bytes,1,rep,name=peers,proto3" json:"peers,omitempty"`
}

func (x *HubOptions_Server) Reset() {
	*x = HubOptions_Server{}
	if protoimpl.UnsafeEnabled {
...
func (x *HubOptions_Server) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HubOptions_Server) ProtoMessage() {}

func (x *HubOptions_Server) ProtoReflect() protoreflect.Message {
	mi := &file_v1_config_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HubOptions_Server.ProtoReflect.Descriptor instead.
func (*HubOptions_Server) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{1, 1}
}

func (x *HubOptions_Server) GetPeers() []*PeerOptions {
	if x != nil {
		return x.Peers
	}
	return nil
...
var file_v1_config_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xe3, 0x01, 0x0a, 0x06, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x14, 0x0a,
	...
	,
	...
	,
	...
	,
	...
	0x6c, 0x75, 0x64, 0x65, 0x73, 0x12, 0x16, 0x0a, 0x04, 0x63, 0x72, 0x6f, 0x6e, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x09, 0x42, 0x02, 0x18, 0x01, 0x52, 0x04, 0x63, 0x72, 0x6f, 0x6e, 0x12, 0x28, 0x0a,
...
>>>>>>> fda6f3b (more refactoring)
	...
	,
	...
	0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e, 0x6d, 0x61, 0x78, 0x55, 0x6e, 0x75, 0x73, 0x65, 0x64,
...
>>>>>>> fda6f3b (more refactoring)
	...
	0x6e, 0x63, 0x79, 0x48, 0x6f, 0x75, 0x72, 0x73, 0x42, 0x0a, 0x0a, 0x08, 0x73, 0x63, 0x68, 0x65,
	0x64, 0x75, 0x6c, 0x65, 0x22, 0xb5, 0x0b, 0x0a, 0x04, 0x48, 0x6f, 0x6f, 0x6b, 0x12, 0x32, 0x0a,
	...
	0x6f, 0x6e, 0x53, 0x68, 0x6f, 0x75, 0x74, 0x72, 0x72, 0x72, 0x1a, 0x23, 0x0a, 0x07, 0x43, 0x6f,
	...
	,
	...
	0x54, 0x10, 0x02, 0x1a, 0x46, 0x0a, 0x07, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x72, 0x64, 0x12, 0x1f,
<<<<<<< HEAD
=======
	,
...
>>>>>>> de36316 (initial protobuffers for multihost)
=======
>>>>>>> fda6f3b (more refactoring)
	...
	0x65, 0x54, 0x65, 0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x1a, 0x44, 0x0a, 0x05, 0x53, 0x6c, 0x61,
	0x63, 0x6b, 0x12, 0x1f, 0x0a, 0x0b, 0x77, 0x65, 0x62, 0x68, 0x6f, 0x6f, 0x6b, 0x5f, 0x75, 0x72,
	...
	,
	...
	0x22, 0x51, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	...
	0x02, 0x20, 0x01, 0x28, 0x09, 0x48, 0x00, 0x52, 0x0e, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72,
	0x64, 0x42, 0x63, 0x72, 0x79, 0x70, 0x74, 0x42, 0x0a, 0x0a, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77,
	0x6f, 0x72, 0x64, 0x42, 0x2c, 0x5a, 0x2a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
...
var file_v1_config_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_v1_config_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_v1_config_proto_goTypes = []interface{}{
	...
	(Hook_Condition)(0),                        // 2: v1.Hook.Condition
	(Hook_OnError)(0),                          // 3: v1.Hook.OnError
	(Hook_Webhook_Method)(0),                   // 4: v1.Hook.Webhook.Method
	(*Config)(nil),                             // 5: v1.Config
	(*HubOptions)(nil),                         // 6: v1.HubOptions
	(*PeerOptions)(nil),                        // 7: v1.PeerOptions
	(*Repo)(nil),                               // 8: v1.Repo
	(*Plan)(nil),                               // 9: v1.Plan
	...
	(*Auth)(nil),                               // 16: v1.Auth
	(*User)(nil),                               // 17: v1.User
	(*HubOptions_Client)(nil),                  // 18: v1.HubOptions.Client
	(*HubOptions_Server)(nil),                  // 19: v1.HubOptions.Server
	(*RetentionPolicy_TimeBucketedCounts)(nil), // 20: v1.RetentionPolicy.TimeBucketedCounts
	(*Hook_Command)(nil),                       // 21: v1.Hook.Command
	(*Hook_Webhook)(nil),                       // 22: v1.Hook.Webhook
	(*Hook_Discord)(nil),                       // 23: v1.Hook.Discord
	(*Hook_Gotify)(nil),                        // 24: v1.Hook.Gotify
	(*Hook_Slack)(nil),                         // 25: v1.Hook.Slack
	(*Hook_Shoutrrr)(nil),                      // 26: v1.Hook.Shoutrrr
}
var file_v1_config_proto_depIdxs = []int32{
	8,  // 0: v1.Config.repos:type_name -> v1.Repo
	9,  // 1: v1.Config.plans:type_name -> v1.Plan
	16, // 2: v1.Config.auth:type_name -> v1.Auth
	6,  // 3: v1.Config.hub_options:type_name -> v1.HubOptions
	18, // 4: v1.HubOptions.client:type_name -> v1.HubOptions.Client
	19, // 5: v1.HubOptions.server:type_name -> v1.HubOptions.Server
	12, // 6: v1.Repo.prune_policy:type_name -> v1.PrunePolicy
	13, // 7: v1.Repo.check_policy:type_name -> v1.CheckPolicy
	15, // 8: v1.Repo.hooks:type_name -> v1.Hook
	10, // 9: v1.Repo.command_prefix:type_name -> v1.CommandPrefix
	14, // 10: v1.Plan.schedule:type_name -> v1.Schedule
	11, // 11: v1.Plan.retention:type_name -> v1.RetentionPolicy
	15, // 12: v1.Plan.hooks:type_name -> v1.Hook
	0,  // 13: v1.CommandPrefix.io_nice:type_name -> v1.CommandPrefix.IONiceLevel
	1,  // 14: v1.CommandPrefix.cpu_nice:type_name -> v1.CommandPrefix.CPUNiceLevel
	20, // 15: v1.RetentionPolicy.policy_time_bucketed:type_name -> v1.RetentionPolicy.TimeBucketedCounts
	14, // 16: v1.PrunePolicy.schedule:type_name -> v1.Schedule
	14, // 17: v1.CheckPolicy.schedule:type_name -> v1.Schedule
	2,  // 18: v1.Hook.conditions:type_name -> v1.Hook.Condition
	3,  // 19: v1.Hook.on_error:type_name -> v1.Hook.OnError
	21, // 20: v1.Hook.action_command:type_name -> v1.Hook.Command
	22, // 21: v1.Hook.action_webhook:type_name -> v1.Hook.Webhook
	23, // 22: v1.Hook.action_discord:type_name -> v1.Hook.Discord
	24, // 23: v1.Hook.action_gotify:type_name -> v1.Hook.Gotify
	25, // 24: v1.Hook.action_slack:type_name -> v1.Hook.Slack
	26, // 25: v1.Hook.action_shoutrrr:type_name -> v1.Hook.Shoutrrr
	17, // 26: v1.Auth.users:type_name -> v1.User
	7,  // 27: v1.HubOptions.Server.peers:type_name -> v1.PeerOptions
	4,  // 28: v1.Hook.Webhook.method:type_name -> v1.Hook.Webhook.Method
...
func file_v1_config_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_v1_config_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HubOptions_Client); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_v1_config_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*HubOptions_Server); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_v1_config_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
	...
	file_v1_config_proto_msgTypes[1].OneofWrappers = []interface{}{
		(*HubOptions_Client_)(nil),
		(*HubOptions_Server_)(nil),
	}
	...
	file_v1_config_proto_msgTypes[10].OneofWrappers = []interface{}{
	...
	file_v1_config_proto_msgTypes[12].OneofWrappers = []interface{}{
