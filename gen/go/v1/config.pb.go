...
type Config struct {
	...
	Ui            *UiSetting `protobuf:"bytes,8,opt,name=ui,proto3" json:"ui,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *UiSetting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UiSetting) ProtoMessage() {}

func (x *UiSetting) ProtoReflect() protoreflect.Message {
	mi := &file_v1_config_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UiSetting.ProtoReflect.Descriptor instead.
func (*UiSetting) Descriptor() ([]byte, []int) {
	return file_v1_config_proto_rawDescGZIP(), []int{13}
}

func (x *UiSetting) GetUseCompactUi() bool {
	if x != nil {
...
const file_v1_config_proto_rawDesc = "" +
	...
	"\x02ui\x18\b \x01(\v2\r.v1.UiSettingR\x02ui\"\xcd\x04\n" +
	"\tMultihost\x12*\n" +
...
var file_v1_config_proto_depIdxs = []int32{
	...
	20, // 5: v1.Config.ui:type_name -> v1.UiSetting
	32, // 6: v1.Multihost.identity:type_name -> v1.PrivateKey
	22, // 7: v1.Multihost.known_hosts:type_name -> v1.Multihost.Peer
	22, // 8: v1.Multihost.authorized_clients:type_name -> v1.Multihost.Peer
	14, // 9: v1.Repo.prune_policy:type_name -> v1.PrunePolicy
	15, // 10: v1.Repo.check_policy:type_name -> v1.CheckPolicy
	17, // 11: v1.Repo.hooks:type_name -> v1.Hook
	12, // 12: v1.Repo.command_prefix:type_name -> v1.CommandPrefix
	...
	16, // 19: v1.PrunePolicy.schedule:type_name -> v1.Schedule
	16, // 20: v1.CheckPolicy.schedule:type_name -> v1.Schedule
	3,  // 21: v1.Schedule.clock:type_name -> v1.Schedule.Clock
	4,  // 22: v1.Hook.conditions:type_name -> v1.Hook.Condition
	5,  // 23: v1.Hook.on_error:type_name -> v1.Hook.OnError
	25, // 24: v1.Hook.action_command:type_name -> v1.Hook.Command
	26, // 25: v1.Hook.action_webhook:type_name -> v1.Hook.Webhook
	27, // 26: v1.Hook.action_discord:type_name -> v1.Hook.Discord
	28, // 27: v1.Hook.action_gotify:type_name -> v1.Hook.Gotify
	29, // 28: v1.Hook.action_slack:type_name -> v1.Hook.Slack
	30, // 29: v1.Hook.action_shoutrrr:type_name -> v1.Hook.Shoutrrr
	31, // 30: v1.Hook.action_healthchecks:type_name -> v1.Hook.Healthchecks
	19, // 31: v1.Auth.users:type_name -> v1.User
	23, // 32: v1.Multihost.Peer.permissions:type_name -> v1.Multihost.Permission
	0,  // 33: v1.Multihost.Permission.type:type_name -> v1.Multihost.Permission.Type
	6,  // 34: v1.Hook.Webhook.method:type_name -> v1.Hook.Webhook.Method
