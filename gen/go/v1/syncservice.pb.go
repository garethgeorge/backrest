...
var file_v1_syncservice_proto_rawDesc = []byte{
	...
	0x65, 0x12, 0x46, 0x0a, 0x09, 0x68, 0x61, 0x6e, 0x64, 0x73, 0x68, 0x61, 0x6b, 0x65, 0x18, 0x0a,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x12, 0x44, 0x0a, 0x08, 0x74, 0x68, 0x72, 0x6f, 0x74, 0x74, 0x6c,
	...
	0x00, 0x52, 0x08, 0x74, 0x68, 0x72, 0x6f, 0x74, 0x74, 0x6c, 0x65, 0x12, 0x66, 0x0a, 0x17, 0x65,
	0x73, 0x74, 0x61, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x5f, 0x73, 0x68, 0x61, 0x72, 0x65, 0x64, 0x5f,
	0x73, 0x65, 0x63, 0x72, 0x65, 0x74, 0x18, 0x17, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x2c, 0x2e, 0x76,
	...
	0x72, 0x65, 0x74, 0x1a, 0xa2, 0x01, 0x0a, 0x13, 0x53, 0x79, 0x6e, 0x63, 0x41, 0x63, 0x74, 0x69,
	...
	0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x22, 0x2e, 0x0a, 0x0c, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65,
	...
	0x05, 0x72, 0x65, 0x70, 0x6f, 0x73, 0x2a, 0xfb, 0x01, 0x0a, 0x13, 0x53, 0x79, 0x6e, 0x63, 0x43,
	...
	0x4f, 0x4c, 0x10, 0x0b, 0x32, 0x93, 0x01, 0x0a, 0x13, 0x42, 0x61, 0x63, 0x6b, 0x72, 0x65, 0x73,
	0x74, 0x53, 0x79, 0x6e, 0x63, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x34, 0x0a, 0x04,
	0x53, 0x79, 0x6e, 0x63, 0x12, 0x12, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x79, 0x6e, 0x63, 0x53, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x49, 0x74, 0x65, 0x6d, 0x1a, 0x12, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x79,
	0x6e, 0x63, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x49, 0x74, 0x65, 0x6d, 0x22, 0x00, 0x28, 0x01,
	0x30, 0x01, 0x12, 0x46, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x52, 0x65, 0x6d, 0x6f, 0x74, 0x65, 0x52,
	0x65, 0x70, 0x6f, 0x73, 0x12, 0x16, 0x2e, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2e, 0x70, 0x72,
...
var file_v1_syncservice_proto_msgTypes = make([]protoimpl.MessageInfo, 11)
var file_v1_syncservice_proto_goTypes = []any{
	...
	(*GetRemoteReposResponse_RemoteRepoMetadata)(nil), // 5: v1.GetRemoteReposResponse.RemoteRepoMetadata
	(*SyncStreamItem_SyncActionHandshake)(nil),        // 6: v1.SyncStreamItem.SyncActionHandshake
	(*SyncStreamItem_SyncActionSendConfig)(nil),       // 7: v1.SyncStreamItem.SyncActionSendConfig
	(*SyncStreamItem_SyncActionConnectRepo)(nil),      // 8: v1.SyncStreamItem.SyncActionConnectRepo
	(*SyncStreamItem_SyncActionDiffOperations)(nil),   // 9: v1.SyncStreamItem.SyncActionDiffOperations
	(*SyncStreamItem_SyncActionSendOperations)(nil),   // 10: v1.SyncStreamItem.SyncActionSendOperations
	(*SyncStreamItem_SyncActionThrottle)(nil),         // 11: v1.SyncStreamItem.SyncActionThrottle
	(*SyncStreamItem_SyncEstablishSharedSecret)(nil),  // 12: v1.SyncStreamItem.SyncEstablishSharedSecret
	(*SignedMessage)(nil),                             // 13: v1.SignedMessage
	(*Repo)(nil),                                      // 14: v1.Repo
...
var file_v1_syncservice_proto_depIdxs = []int32{
	5,  // 0: v1.GetRemoteReposResponse.repos:type_name -> v1.GetRemoteReposResponse.RemoteRepoMetadata
	13, // 1: v1.SyncStreamItem.signed_message:type_name -> v1.SignedMessage
	6,  // 2: v1.SyncStreamItem.handshake:type_name -> v1.SyncStreamItem.SyncActionHandshake
	9,  // 3: v1.SyncStreamItem.diff_operations:type_name -> v1.SyncStreamItem.SyncActionDiffOperations
	10, // 4: v1.SyncStreamItem.send_operations:type_name -> v1.SyncStreamItem.SyncActionSendOperations
	7,  // 5: v1.SyncStreamItem.send_config:type_name -> v1.SyncStreamItem.SyncActionSendConfig
	11, // 6: v1.SyncStreamItem.throttle:type_name -> v1.SyncStreamItem.SyncActionThrottle
	12, // 7: v1.SyncStreamItem.establish_shared_secret:type_name -> v1.SyncStreamItem.SyncEstablishSharedSecret
	14, // 8: v1.RemoteConfig.repos:type_name -> v1.Repo
	15, // 9: v1.SyncStreamItem.SyncActionHandshake.public_key:type_name -> v1.PublicKey
	13, // 10: v1.SyncStreamItem.SyncActionHandshake.instance_id:type_name -> v1.SignedMessage
