...
const file_v1_syncservice_proto_rawDesc = "" +
	"\n" +
	"\x14v1/syncservice.proto\x12\x02v1\x1a\x0fv1/config.proto\x1a\x0fv1/crypto.proto\x1a\x0fv1/restic.proto\x1a\x10v1/service.proto\x1a\x13v1/operations.proto\x1a\x11types/value.proto\x1a\x1bgoogle/protobuf/empty.proto\x1a\x1cgoogle/api/annotations.proto\"\xad\x01\n" +
	"\x16GetRemoteReposResponse\x12C\n" +
	"\x05repos\x18\x01 \x03(\v2-.v1.GetRemoteReposResponse.RemoteRepoMetadataR\x05repos\x1aN\n" +
	"\x12RemoteRepoMetadata\x12\x1f\n" +
	"\vinstance_id\x18\x01 \x01(\tR\n" +
	"instanceId\x12\x17\n" +
	"\arepo_id\x18\x02 \x01(\tR\x06repoId\"\xc1\v\n" +
	"\x0eSyncStreamItem\x12:\n" +
	"\x0esigned_message\x18\x01 \x01(\v2\x11.v1.SignedMessageH\x00R\rsignedMessage\x12F\n" +
	"\thandshake\x18\x03 \x01(\v2&.v1.SyncStreamItem.SyncActionHandshakeH\x00R\thandshake\x12V\n" +
	...
	"sendConfig\x12f\n" +
	"\x17establish_shared_secret\x18\x17 \x01(\v2,.v1.SyncStreamItem.SyncEstablishSharedSecretH\x00R\x15establishSharedSecret\x12D\n" +
	...
	"\x06config\x18\x01 \x01(\v2\x10.v1.RemoteConfigR\x06config\x1a0\n" +
	...
	"\x06action\"4\n" +
	"\fRemoteConfig\x12$\n" +
	"\x05repos\x18\x01 \x03(\v2\x0e.v1.RemoteRepoR\x05repos\"\x86\x01\n" +
	"\n" +
	"RemoteRepo\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	"\x04guid\x18\v \x01(\tR\x04guid\x12\x10\n" +
	"\x03uri\x18\x02 \x01(\tR\x03uri\x12\x1a\n" +
	"\bpassword\x18\x03 \x01(\tR\bpassword\x12\x10\n" +
	"\x03env\x18\x04 \x03(\tR\x03env\x12\x14\n" +
	"\x05flags\x18\x05 \x03(\tR\x05flags*\xfb\x01\n" +
	...
	"\x12#\n" +
	"\x1fCONNECTION_STATE_ERROR_PROTOCOL\x10\v2\x93\x01\n" +
	"\x13BackrestSyncService\x124\n" +
	"\x04Sync\x12\x12.v1.SyncStreamItem\x1a\x12.v1.SyncStreamItem\"\x00(\x010\x01\x12F\n" +
	"\x0eGetRemoteRepos\x12\x16.google.protobuf.Empty\x1a\x1a.v1.GetRemoteReposResponse\"\x00B,Z*github.com/garethgeorge/backrest/gen/go/v1b\x06proto3"
