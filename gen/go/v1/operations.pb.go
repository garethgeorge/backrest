...
var file_v1_operations_proto_rawDesc = []byte{
	...
	0x0a, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x96, 0x07, 0x0a, 0x09,
	...
	0x3d, 0x0a, 0x0f, 0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x63, 0x68, 0x65,
	0x63, 0x6b, 0x18, 0x6b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e, 0x76, 0x31, 0x2e, 0x4f, 0x70,
	0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x48, 0x00, 0x52, 0x0e,
	0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x42, 0x04,
...
var file_v1_operations_proto_goTypes = []interface{}{
	...
	(*BackupProgressEntry)(nil),    // 13: v1.BackupProgressEntry
	(*BackupProgressError)(nil),    // 14: v1.BackupProgressError
	(*ResticSnapshot)(nil),         // 15: v1.ResticSnapshot
	(*RetentionPolicy)(nil),        // 16: v1.RetentionPolicy
	(*RestoreProgressEntry)(nil),   // 17: v1.RestoreProgressEntry
	(*RepoStats)(nil),              // 18: v1.RepoStats
	(Hook_Condition)(0),            // 19: v1.Hook.Condition
}
var file_v1_operations_proto_depIdxs = []int32{
	...
	0,  // 10: v1.OperationEvent.type:type_name -> v1.OperationEventType
	3,  // 11: v1.OperationEvent.operation:type_name -> v1.Operation
	13, // 12: v1.OperationBackup.last_status:type_name -> v1.BackupProgressEntry
	14, // 13: v1.OperationBackup.errors:type_name -> v1.BackupProgressError
